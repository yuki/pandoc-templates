...
%     https://github.com/yuki/pandoc-templates/
%
% License:
...
\setlength{\fboxsep}{0pt} % \fbox without padding
...
\RequirePackage[fixed, style=regular]{fontawesome7}
...
\newenvironment{warnbox}{
  \begin{custombox}{orange!80!black}{orange!5!white}{\warnname}{\faCircleExclamation}
}{
  \end{custombox}
}

\newenvironment{errorbox}{
  \begin{custombox}{error-color}{red!4!white}{\errorname}{\faTriangleExclamation}
}{
  \end{custombox}
}

\newenvironment{questionbox}{
  \begin{custombox}{Goldenrod}{white}{\questionname}{\faCircleQuestion[solid]}
}{
  \end{custombox}
}

\newenvironment{exercisebox}[1]{
  \begin{custombox}{teal}{teal!4!white}{\exercisename { \hypersetup{allcolors=white} #1}}{\faGear}
}{
  \end{custombox}
}
