...
\begin{flushleft}
    ...
    Puedes encontrar la última versión de este libro en formato \textbf{HTML} en el siguiente \href{https://github.com/yuki/my-books}{link}, así como otros libros que he creado. Para descargar el código fuente en formato \textbf{Markdown} visita el repositorio en \href{https://github.com/yuki/my-books}{GitHub}.
