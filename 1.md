...
Sometimes we need inline console code like [ls path]{.commandbox} , other times we need to talk about some configuration file like [[/etc/hosts](https://en.wikipedia.org/wiki/Hosts_(file))]{.configfile} , config directory [/etc]{.configdir}, inline text [help]{.inlineconsole}, [int("5")]{.verbatim} or `int("5")` for verbatim text/code, or a movie [[The Imitation Game](https://www.imdb.com/title/tt2084970/)]{.movie}.

This is an **infobox**:

::: infobox
**This is an infobox! With a list and [link](https://github.com/yuki/my-books)**
...
**This is an exercisebox with solution link**

::: {.exercisebox }
[[01](https://github.com/yuki/pandoc-templates/) y [02](https://github.com/yuki/pandoc-templates/)]{.solution}

**This is a exercisebox with solution links in the title**
:::
